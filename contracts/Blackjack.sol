...
contract Blackjack {
    ...
    uint private constant INITIAL_DECK_SIZE = 52;
    ...
    // New hit function added
    function hit() public {
        string memory newCard = dealCard();
        playerHand.push(newCard);
        emit CardDealt(newCard);
    }

    function dealCard() private returns (string memory) {
